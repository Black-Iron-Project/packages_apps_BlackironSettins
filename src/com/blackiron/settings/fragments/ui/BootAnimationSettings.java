...
import com.blackiron.settings.preferences.BootAnimationPreviewPreference;
...
public class BootAnimationSettings extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.blackiron_settings_bootanimation);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.blackiron_settings_bootanimation;
                    result.add(sir);
                    return result;
                }
